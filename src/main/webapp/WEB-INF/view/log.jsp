			...
			<form role="form" class="form-inline">
				<div class="col-sm-3">
					<div class="form-group">
						...
						<input type="test" name="username"   placeholder=""id="txt_search_username"   class="form-control">
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label  class="control-label">操作类型</label>
						<input type="test"   name="operation" placeholder="" id="txt_search_operation"  class="form-control">
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label  class="control-label">所属模块</label>
						<input type="test"   name="module" placeholder="" id="txt_search_module" class="form-control">
					</div>
				</div>
