...
<script src="${path }/resources/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="${path }/resources/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${path }/resources/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="${path }/resources/js/plugins/flot/jquery.flot.symbol.js"></script>
<!-- Peity -->
<script src="${path }/resources/js/plugins/peity/jquery.peity.min.js"></script>
<script src="${path }/resources/js/demo/peity-demo.js"></script>
...
<!-- Sparkline -->
<script src="${path }/resources/js/plugins/sparkline/jquery.sparkline.min.js"></script>
